...
import { X, TrendingUp, Flame, Ticket, Sparkles } from 'lucide-react';
...
export function UpgradeModal({ isOpen, onClose, flower, balance, onUpgrade }: UpgradeModalProps) {
    ...
    switch (upgradeState) {
        ...
        return (
          <div className="text-center py-6">
            ...
            <p className="text-muted-foreground mb-4">
              Your flower is now Level {nextLevel}!
            </p>
            ...
            <button
              onClick={onClose}
              className="mt-6 w-full py-3 rounded-xl bloom-gradient-button text-white font-medium"
            >
              Continue Blooming
            </button>
          </div>
      ...
      case 'failed':
        return (
          <div className="text-center py-6">
            <div className="relative mb-4">
              <div className="text-7xl opacity-50 grayscale">
                {getFlowerEmoji(currentLevel, true)}
              </div>
            ...
            <p className="text-muted-foreground mb-4">
              Your flower remains at Level {currentLevel}
            </p>
            {result && (
            ...
            <button
              onClick={onClose}
              className="mt-6 w-full py-3 rounded-xl bg-secondary text-foreground font-medium"
            >
              Try Again Later
            </button>
          </div>
      ...
      default: // confirm
        return (
          <>
            ...
            >
              {canAfford ? `Upgrade to Level ${nextLevel}` : 'Insufficient BLOOM'}
            </button>
          </>
        );
    }
